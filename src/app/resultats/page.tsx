      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-4 py-8 md:py-12 flex flex-col gap-6">
        ...
        <div
          className={`rounded-2xl p-6 border flex flex-col md:flex-row items-center gap-6
            bg-[color:var(--sc-surface)] shadow-[var(--sc-shadow)]`}
        >
          {/* Circle score */}
          <div className="shrink-0 flex flex-col items-center gap-2">
            <div
              className="w-32 h-32 rounded-full flex flex-col items-center justify-center border-[5px]
                bg-[color:var(--sc-bg)]"
        ...
        >
          ...
          <div
            className="mt-3 pt-3 border-t border-[color:var(--sc-border)]
              flex items-start gap-2 text-xs text-[color:var(--sc-text-muted)]"
          >
            <Info className="w-3.5 h-3.5 shrink-0 mt-0.5" />
            <span>
              Ce résultat est issu d&apos;un <strong className="text-[color:var(--sc-text-2)]">audit de qualification rapide</strong> (10 questions).
              Il permet d&apos;identifier tes priorités immédiates, mais ne remplace pas un audit complet.
              Pour un diagnostic plus précis, tu pourras lancer un audit standard ou complet.
            </span>
          </div>
        </div>
            ...
            <div className="rounded-xl border border-[color:var(--sc-border)] overflow-hidden">
              <button
                ...
                className="w-full flex items-center justify-between px-4 py-3
                  bg-[color:var(--sc-surface-2)] hover:bg-[color:var(--sc-bg-soft)]
                  text-sm font-semibold text-[color:var(--sc-text)] transition-colors cursor-pointer"
        ...
        <div
          className="rounded-2xl p-5 border
            bg-[color:var(--sc-surface)] border-[color:var(--sc-border)]
            shadow-[var(--sc-shadow-sm)]"
        >
        ...
        <div
          className="rounded-2xl p-5 border
            bg-[rgba(37,99,235,0.04)] border-[rgba(37,99,235,0.18)]
            shadow-[var(--sc-shadow-sm)]"
        >
          <div className="flex items-center gap-2 mb-3">
            <span
