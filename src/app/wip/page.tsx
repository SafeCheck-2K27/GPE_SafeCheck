    ...
    <div className="min-h-screen flex flex-col bg-[#FFFFFF] font-sans">
      ...
      <main className="flex-1 px-4 py-10 md:py-16">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="relative rounded-2xl p-8 md:p-12 text-center sc-fade-in overflow-hidden
            border border-[color:var(--sc-border)] sc-mesh-soft
            shadow-[var(--sc-shadow-md)]">
