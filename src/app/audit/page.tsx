  ...
  return (
    <div className="min-h-screen flex flex-col bg-[color:var(--sc-bg)] font-sans">
      ...
      <main className="flex-1 flex relative">
        ...
        {/* Sidebar - progression */}
        <aside
          className={`relative z-10 transition-[width] duration-300 ease-out shrink-0 ${sidebarOpen ? "w-72" : "w-0 overflow-hidden"}`}
        >
          <div
            className="h-full flex flex-col bg-[color:var(--sc-surface)] border-r border-[color:var(--sc-border)] shadow-[var(--sc-shadow-sm)]"
          >
            {/* Sidebar header */}
            <div className="px-5 pt-5 pb-4 border-b border-[color:var(--sc-border)]">
              <div className="flex items-center gap-2 mb-2">
                <span
                  className="inline-flex items-center justify-center w-7 h-7 rounded-md bg-[linear-gradient(135deg,var(--sc-blue-soft),var(--sc-blue))] text-white shadow-[var(--sc-shadow-blue-sm)]"
                >
        ...
        <div className="flex-1 flex flex-col relative z-10 min-w-0">
          ...
          <div
            className="flex items-center gap-4 px-4 md:px-6 py-3 border-b border-[color:var(--sc-border)] bg-[color:var(--sc-surface)]/70 backdrop-blur-md supports-[backdrop-filter]:bg-[color:var(--sc-surface)]/60"
          >
            <button
              ...
              <div className="flex items-end gap-5 md:gap-6">
                <div className="shrink-0 flex flex-col items-center">
                  <div className="relative">
                    ...
                    />
                    <div
                      className="relative w-20 h-20 rounded-full sc-avatar-gradient flex items-center justify-center ring-4 ring-[color:var(--sc-surface)] shadow-[0_14px_30px_-10px_rgba(37,99,235,0.55),inset_0_1px_0_rgba(255,255,255,0.30)]"
                    >
                ...
                <div
                  className="flex-1 relative rounded-2xl p-5 md:p-6 bg-[color:var(--sc-surface)] border border-[color:var(--sc-border)] shadow-[var(--sc-shadow)]"
                >
                  <span
                    aria-hidden
