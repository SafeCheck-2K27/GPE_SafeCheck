      ...
      <main className="flex-1">
        ...
        <section className="relative">
          <div className="max-w-7xl mx-auto px-4 pt-8 md:pt-12">
            <div
              className="relative overflow-hidden rounded-2xl border border-[color:var(--sc-border)]
              bg-[color:var(--sc-surface)]
              shadow-[0_2px_6px_-2px_rgba(15,23,42,0.06),0_10px_30px_-12px_rgba(15,23,42,0.10)]"
            >
              <div
        ...
        <section className="max-w-7xl mx-auto px-4 pt-10 pb-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-4">
            {/* Steps strip */}
            <div
              className="relative rounded-2xl border border-[color:var(--sc-border)]
              bg-[color:var(--sc-surface)]
                      ...
                      <div className="flex sm:flex-col gap-3 sm:gap-0 flex-1 pb-8 sm:pb-0 sm:px-4 last:pb-0">
                        ...
                        <div className="flex items-center gap-2.5 sm:justify-center sm:mb-4 shrink-0">
                          <div
                            ...
                            text-white text-sm font-bold relative z-10
                            bg-[linear-gradient(135deg,#3B82F6,#2563EB)]
                            shadow-[0_4px_12px_-4px_rgba(37,99,235,0.55)]"
                          >
                            {step.number}
                          </div>
                        </div>
            ...
            <div
              className="lg:w-64 rounded-2xl border border-[color:var(--sc-blue)]/30
              bg-[#EEF4FF]
              shadow-[0_2px_6px_-2px_rgba(37,99,235,0.12)]
            ...
            >
              ...
              <div className="relative">
                <div
                  ...
                  bg-[linear-gradient(135deg,#3B82F6,#2563EB)]
                  shadow-[0_8px_20px_-6px_rgba(37,99,235,0.55)]"
                >
              ...
              <button
                ...
                className="relative mt-auto inline-flex items-center justify-between gap-2 w-full px-3.5 py-2 rounded-lg
                text-xs font-semibold
                text-[color:var(--sc-blue)]
                bg-[color:var(--sc-surface)] border border-[color:var(--sc-blue)]/25
                hover:bg-[color:var(--sc-blue)] hover:text-white hover:border-[color:var(--sc-blue)]
                transition-colors"
              >
                Voir les tutoriels
          ...
          <div className="max-w-xl mx-auto">
            ...
            <form onSubmit={onSearch} className="flex items-stretch gap-2">
              <div
                ...
                bg-[color:var(--sc-surface)] border border-[color:var(--sc-border-strong)]
                focus-within:border-[color:var(--sc-blue)]
                focus-within:ring-2 focus-within:ring-[color:var(--sc-blue)]/25
                transition-all"
              >
        ...
        {isHydrated && (
          <section className="max-w-7xl mx-auto px-4 pb-12">
            <div
              className="relative overflow-hidden rounded-2xl p-6 md:p-8 grid grid-cols-1 md:grid-cols-[1fr_auto] gap-6 items-center
        ...
        <section className="max-w-7xl mx-auto px-4 pb-16">
          ...
          <div
            className="relative rounded-2xl border border-[color:var(--sc-border)] bg-[color:var(--sc-surface)]
            shadow-[0_2px_6px_-2px_rgba(15,23,42,0.06),0_10px_30px_-12px_rgba(15,23,42,0.08)]
            p-6 md:p-10"
          >
            <Quote
            ...
            <div className="flex flex-col md:flex-row items-center gap-6">
              <button
                ...
                className="hidden md:inline-flex p-2.5 rounded-full border border-[color:var(--sc-border-strong)]
                bg-[color:var(--sc-surface)] hover:border-[color:var(--sc-blue)] hover:text-[color:var(--sc-blue)]
              ...
              <div className="flex-1 flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
                <div
                  className="relative w-20 h-20 md:w-24 md:h-24 rounded-full shrink-0 flex items-center justify-center text-white text-3xl font-display font-bold
                  bg-[linear-gradient(135deg,#3B82F6,#2563EB_55%,#6366F1)]
                  shadow-[0_12px_28px_-10px_rgba(37,99,235,0.55)]"
                >
            ...
            <div className="mt-6 flex items-center justify-between gap-3">
              <button
                onClick={prevTestimonial}
                className="md:hidden inline-flex p-2 rounded-full border border-[color:var(--sc-border-strong)]
                bg-[color:var(--sc-surface)]"
                aria-label="Témoignage précédent"
              >
                <ChevronLeft className="w-4 h-4" />
                ...
                {testimonials.map((_, i) => (
                  <button
                    ...
                    className={`h-2 rounded-full transition-all ${
                      i === testimonialIndex
                        ? "w-6 bg-[color:var(--sc-blue)]"
                        : "w-2 bg-[color:var(--sc-border-strong)]"
                    }`}
...
function DiagnosticCard() {
  ...
  return (
    <div
      className="lg:w-64 shrink-0 rounded-2xl border border-[color:var(--sc-border)]
      bg-[color:var(--sc-surface)]
      shadow-[0_4px_16px_-6px_rgba(37,99,235,0.14),0_2px_6px_-2px_rgba(15,23,42,0.06)]
      overflow-hidden"
      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-3 mb-4">
          <div
            ...
            border-[3px] border-[color:var(--sc-blue)]
            bg-[color:var(--sc-blue)]/8"
          >
          ...
          {priorities.map((p, i) => (
            ...
            >
              <span
                ...
                text-[color:var(--sc-blue)] bg-[color:var(--sc-blue)]/10"
              >
                {p.icon}
              </span>
              ...
              <span
                className={`shrink-0 text-[10px] font-semibold px-1.5 py-0.5 rounded-md ${
                  p.level === "Critique"
                    ...
                    : "bg-[color:var(--sc-border)] text-[color:var(--sc-text-muted)]"
                }`}
              >
                {p.level}
              </span>
...
function ModuleCard({
  ...
  return (
    <article
      ...
      hover:shadow-[0_16px_32px_-12px_rgba(37,99,235,0.16),0_6px_14px_-6px_rgba(15,23,42,0.08)]
      hover:border-[color:var(--sc-blue)]/30 hover:-translate-y-0.5
      transition-all duration-300 ease-out sc-fade-in"
      style={{ animationDelay: `${index * 60}ms` }}
    >
      <div className="flex items-center justify-between mb-3">
        <div
          className={`inline-flex items-center justify-center w-10 h-10 rounded-xl text-white
          bg-gradient-to-br ${toneGradient[tone]} group-hover:scale-105 transition-transform`}
        >
          {icon}
        </div>
      ...
      <button
        onClick={onClick}
        className="mt-4 inline-flex items-center justify-between gap-2 w-full px-4 py-2 rounded-lg
