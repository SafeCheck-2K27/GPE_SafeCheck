    ...
    <div className="min-h-screen flex flex-col font-sans bg-[color:var(--sc-bg)]">
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden sc-mesh">
          ...
          {/* glow blobs */}
          <div
            className="pointer-events-none absolute -top-32 -left-24 w-[480px] h-[480px] rounded-full sc-pulse-soft"
            style={{
              background:
          ...
          />
          <div
            className="pointer-events-none absolute -bottom-40 -right-20 w-[520px] h-[520px] rounded-full sc-pulse-soft"
            style={{
              background:
          ...
          <div className="relative max-w-6xl mx-auto px-4 py-16 md:py-24 lg:py-28 grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-12 lg:gap-16 items-center">
            {/* TEXT COLUMN */}
            <div>
              ...
              <h1 className="font-display text-4xl md:text-6xl lg:text-[68px] font-bold tracking-tight text-[color:var(--sc-text)] mt-5 mb-5 text-balance leading-[1.04] sc-fade-in-delay-1">
                Reprenez la main sur votre{" "}
                <span className="sc-gradient-text">sécurité numérique</span>.
              </h1>

              <p className="text-base md:text-lg text-[color:var(--sc-text-2)] leading-relaxed mb-8 max-w-xl text-pretty sc-fade-in-delay-2">
              ...
              <ul className="mt-7 flex flex-wrap items-center gap-x-5 gap-y-2 text-xs text-[color:var(--sc-text-muted)] sc-fade-in-delay-4">
            ...
            <div className="relative h-[420px] md:h-[480px] lg:h-[520px] flex items-center justify-center">
        ...
        <section className="relative overflow-hidden bg-[color:var(--sc-surface)]">
          <div
            className="pointer-events-none absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 w-[600px] h-[400px] sc-halo opacity-60"
            aria-hidden
          />
          <div className="relative max-w-3xl mx-auto px-4 py-20 text-center">
            <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-[color:var(--sc-bg-soft)] border border-[color:var(--sc-border)] mb-5">
              <Eye className="w-5 h-5 text-[color:var(--sc-blue)]" />
            </div>
            <h2 className="font-display text-3xl md:text-4xl font-bold text-[color:var(--sc-text)] mb-4 text-balance">
              Prêt·e à voir où vous en êtes&nbsp;?
            </h2>
            <p className="text-base text-[color:var(--sc-text-2)] mb-8 max-w-xl mx-auto text-pretty">
...
function HeroShieldComposition() {
  return (
    <div className="relative w-full h-full sc-zoom-in">
      ...
      <div
        className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[360px] h-[360px] rounded-full
        border border-dashed border-[color:var(--sc-blue)]/30"
        aria-hidden
      />
      <div
        className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[280px] h-[280px] rounded-full
        border border-[color:var(--sc-blue)]/15"
        aria-hidden
      />
      ...
      <div className="relative left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 sc-float">
        <div className="relative inline-block">
          ...
          {/* Glass card */}
          <div
            className="relative w-[200px] h-[200px] md:w-[220px] md:h-[220px] rounded-[28px] sc-glass
          ...
          >
            ...
            <div
              className="w-[110px] h-[110px] md:w-[120px] md:h-[120px] rounded-2xl flex items-center justify-center
              shadow-[0_20px_40px_-12px_rgba(37,99,235,0.55),inset_0_1px_0_rgba(255,255,255,0.35)]"
              style={{
            ...
            <span
              className="absolute -top-3 left-1/2 -translate-x-1/2 inline-flex items-center gap-1 px-3 py-1
              rounded-full text-[11px] font-semibold text-white
              bg-[linear-gradient(135deg,#10B981,#059669)]
              shadow-[0_8px_18px_-6px_rgba(16,185,129,0.55)]"
            >
...
function FloatingIcon({
  ...
  return (
    ...
    >
      <div
        className="flex items-center gap-2 pl-2 pr-3 py-2 rounded-full sc-glass border border-white/60
        text-[11.5px] font-semibold text-[color:var(--sc-text)]"
      >
        <span
...
function ValueCard({
  ...
  return (
    <div
      className="group relative rounded-[18px] p-6 bg-[color:var(--sc-surface)] border border-[color:var(--sc-border)]
      transition-all duration-300 ease-out
      hover:-translate-y-1 hover:border-[color:var(--sc-blue)]/40
      hover:shadow-[0_20px_40px_-16px_rgba(37,99,235,0.25),0_8px_16px_-8px_rgba(15,23,42,0.10)]
      shadow-[0_2px_6px_-2px_rgba(15,23,42,0.06)] sc-fade-in"
    ...
    >
      ...
      <div
        ...
        bg-[linear-gradient(135deg,#3B82F6_0%,#2563EB_60%,#6366F1_100%)]
        shadow-[0_8px_18px_-6px_rgba(37,99,235,0.55)]
