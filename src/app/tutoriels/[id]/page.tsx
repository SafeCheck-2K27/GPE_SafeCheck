        ...
        {matches.map((tag) => (
          <Link
            ...
            className="inline-flex items-center gap-1 text-xs px-2.5 py-1 rounded-full font-semibold
              bg-[color:var(--sc-bg-soft)] text-[color:var(--sc-text-2)] border border-[color:var(--sc-border)]
              hover:border-[color:var(--sc-blue)]/45 hover:text-[color:var(--sc-blue)] transition-colors"
          >
        ...
        {sent ? (
          ...
          <div className="p-5 space-y-4">
                  ...
                  >
                    <span
                      className={`w-4 h-4 rounded-full border-2 flex-shrink-0 transition-all ${
                        type === key
                          ? "border-[color:var(--sc-blue)] bg-[color:var(--sc-blue)]"
            ...
            <button
              ...
              className={`flex items-center gap-2.5 w-full px-3 py-2.5 rounded-xl border text-xs font-medium transition-all ${
                anonymous
                  ? "bg-[color:var(--sc-surface-2)] border-[color:var(--sc-border-strong)] text-[color:var(--sc-text)]"
                  : "bg-[color:var(--sc-bg-soft)] border-[color:var(--sc-border)] text-[color:var(--sc-text-2)] hover:border-[color:var(--sc-border-strong)]"
              }`}
            >
              <span
                className={`w-4 h-4 rounded border-2 flex-shrink-0 flex items-center justify-center transition-all ${
                  anonymous
                    ? "bg-[color:var(--sc-blue)] border-[color:var(--sc-blue)]"
                    : "border-[color:var(--sc-border-strong)] bg-transparent"
                }`}
              >
            ...
            {displayedComments.map((comment) => (
              <div
                ...
                className={`rounded-xl p-4 border ${
                  comment.helpful
                    ? "bg-[color:var(--sc-bg-soft)] border-[color:var(--sc-border)]"
                    : "bg-[color:var(--sc-surface-2)] border-[color:var(--sc-border)]"
                }`}
              >
                ...
                {tuto.steps.map((step, i) => (
                  <li
                    ...
                    className={`flex items-start gap-3 rounded-xl p-3 border transition-all ${
                      completedSteps.has(i)
                        ? "bg-[color:var(--sc-success)]/6 border-[color:var(--sc-success)]/25"
                        : "bg-[color:var(--sc-bg-soft)] border-[color:var(--sc-border)] hover:border-[color:var(--sc-blue)]/25"
                    }`}
                  >
                    <span
                      className={`shrink-0 w-6 h-6 rounded-full border-2 flex items-center justify-center text-[10px] font-bold transition-all ${
                        completedSteps.has(i)
                          ? "bg-[color:var(--sc-success)] border-[color:var(--sc-success)] text-white"
                          : "border-[color:var(--sc-border-strong)] text-[color:var(--sc-text-muted)]"
                      }`}
                    >
                    ...
                    <div className="flex-1 min-w-0">
                      <p
                        className={`text-sm font-semibold leading-snug ${
                          completedSteps.has(i)
                            ? "text-[color:var(--sc-success)] line-through decoration-[color:var(--sc-success)]/40"
                            : "text-[color:var(--sc-text)]"
                        }`}
                      >
                        {step.title}
                      </p>
