  ...
  return (
    <button
      ...
      className="w-full inline-flex items-center justify-center gap-2.5 px-4 py-2.5 rounded-lg text-sm font-semibold
        text-[color:var(--sc-text)] bg-[color:var(--sc-surface)]
        border border-[color:var(--sc-border-strong)]
        hover:border-[color:var(--sc-blue)] hover:bg-[color:var(--sc-bg-soft)]/60
        shadow-[0_2px_6px_-2px_rgba(15,23,42,0.08)]
        hover:shadow-[0_8px_22px_-8px_rgba(37,99,235,0.30)]
        hover:-translate-y-0.5
        transition-[transform,box-shadow,background,color,border-color] duration-200 ease-out
        focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--sc-blue)]/45 focus-visible:ring-offset-2 focus-visible:ring-offset-[color:var(--sc-bg)]
