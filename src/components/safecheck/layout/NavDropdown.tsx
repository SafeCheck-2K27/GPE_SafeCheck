          ...
          {footerCta && (
            <>
              ...
              <Link
                href={footerCta.href}
                onClick={onClose}
                className="flex items-center justify-center gap-1.5 mx-1 mb-0.5 px-3 py-2.5 rounded-lg text-sm font-semibold text-[color:var(--sc-blue)] bg-[color:var(--sc-blue)]/8 hover:bg-[color:var(--sc-blue)]/15 hover:text-[color:var(--sc-blue-hover)] transition-colors"
              >
