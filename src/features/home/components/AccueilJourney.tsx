  ...
  return (
    <section className="max-w-7xl mx-auto px-4 pt-10 pb-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-4">
        <div className="relative rounded-2xl border border-[color:var(--sc-border)] bg-[color:var(--sc-surface)] shadow-[0_2px_6px_-2px_rgba(15,23,42,0.06)] overflow-hidden">
          <div
            className="absolute inset-x-0 top-0 h-0.5"
            style={{
              background: "linear-gradient(90deg, #3B82F6, #2563EB 40%, #6366F1 70%, #06B6D4)",
            }}
            aria-hidden
          />
                ...
                <div key={step.number} className="flex sm:flex-col flex-1 relative">
                  ...
                  <div className="flex sm:flex-col gap-3 sm:gap-0 flex-1 pb-8 sm:pb-0 sm:px-4 last:pb-0">
                    <div className="flex items-center gap-2.5 sm:justify-center sm:mb-4 shrink-0">
                      <div className="flex items-center justify-center w-9 h-9 rounded-xl shrink-0 text-white text-sm font-bold relative z-10 bg-[linear-gradient(135deg,#3B82F6,#2563EB)] shadow-[0_4px_12px_-4px_rgba(37,99,235,0.55)]">
                        {step.number}
                      </div>
                    </div>
        ...
        <div className="lg:w-64 rounded-2xl border border-[color:var(--sc-blue)]/30 bg-[#EEF4FF] shadow-[0_2px_6px_-2px_rgba(37,99,235,0.12)] p-5 flex flex-col gap-3 relative overflow-hidden">
          <div
            className="pointer-events-none absolute inset-0 opacity-60"
            style={{
              background: "radial-gradient(at 100% 0%, rgba(99,102,241,0.15), transparent 60%)",
            }}
            aria-hidden
          />
          <div className="relative">
            <div className="inline-flex items-center justify-center w-10 h-10 rounded-xl text-white mb-3 bg-[linear-gradient(135deg,#3B82F6,#2563EB)] shadow-[0_8px_20px_-6px_rgba(37,99,235,0.55)]">
