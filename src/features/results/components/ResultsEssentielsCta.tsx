...
/*
   Passerelle du résultat vers l'action (SC-020). Le diagnostic n'a de
   valeur que s'il débouche sur quelque chose : ce bloc renvoie vers les
   Essentiels (le catalogue d'actions concrètes). Quand un thème faible
   ressort, on le nomme pour que le lien ait un sens.
 */
  ...
  return (
    <ScCard className="p-5">
      ...
      <p className="text-sm text-[color:var(--sc-text-2)] mb-4">
        {priority
          ? `Ton thème le plus fragile est « ${priority.category} ». Les Essentiels regroupent les actions les plus rentables pour le corriger : 20 % des efforts, 80 % de la sécurité.`
