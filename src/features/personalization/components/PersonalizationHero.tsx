  ...
  return (
    <>
      <div className="flex flex-col items-center text-center gap-3">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-semibold bg-[rgba(16,185,129,0.10)] border border-[rgba(16,185,129,0.25)] text-[color:var(--sc-success)]">
          <span
        ...
        <div className="w-14 h-14 rounded-2xl flex items-center justify-center text-white bg-[linear-gradient(135deg,var(--sc-blue-soft),var(--sc-blue),var(--sc-indigo))] shadow-[var(--sc-shadow-blue)]">
